...
A curated library of evaluated methodologies, workflows, and patterns.

## Perspective

These evaluations are written from a specific lens defined in `.claude/skills/evaluate-resource/context.md`. Verdicts reflect that context. Read the "Best used when" and "Poor fit when" sections to judge relevance to your own situation.
